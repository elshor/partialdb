...
function add(object, operation) {
    var endpoint = Pointer.fromJSON(operation.path).evaluate(object, true); //should create path if missing
        ...
        evaluate: {
            ...
            */
            ...
            value: function evaluate(object) {
                var shouldCreate = arguments[1] === undefined ? false : arguments[1];
